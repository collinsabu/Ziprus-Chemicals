    ...
    <main className="bg-base_two my-10">
      <div className="w-full sm:w-3/4 md:w-1/2 mx-auto py-8 text-white bg-base_color px-4 sm:px-8 overflow-hidden">
        {[
          ...
          { label: "Amount Sent", value: payment.amountSent },
          { label: "Crude Type", value: payment.crudeType },
          { label: "Payment Method", value: payment.paymentMethod },
          { label: "Receiver Name", value: payment.receiverName },
        ].map((field) => (
        ...
        <button
          onClick={() => router.push("/viewreport/crudePayment")}
