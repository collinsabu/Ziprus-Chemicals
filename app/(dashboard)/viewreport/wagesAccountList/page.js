// src/app/wagesAccountList/page.js
...
const WagesAccountList = () => {
  ...
  useEffect(() => {
    const fetchEntries = async () => {
      const res = await fetch(`/api/wagesAccounts?month=${month + 1}&year=${year}`);
  ...
  return (
    <main className="bg-base_two">
      ...
      <h1 className="text-2xl font-bold text-white mb-4">Workers Salary List</h1>
...
export default WagesAccountList;
