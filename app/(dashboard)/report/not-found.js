  ...
  return (
    <main className='bg-base_color poppins mt-10 mb-10 sm:mb-16 '>
      <div className="conatiner-error text-center ">
        ...
        <Link href="http://localhost:3000/report" className="text-white bg-base_color text-xl border-2  px-[30px] sm:px-[90px] py-5 sm:py-[15px] rounded-full cursor-pointer hover:bg-lime-950 ease-in-out duration-300 mb-20 mt-5" >Click to go Home</Link>
      </div>
    </main>
  )
}
