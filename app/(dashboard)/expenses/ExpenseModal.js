...
export default function ExpenseModal({ closeModal, fetchExpenses }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <button
              type="button"
              onClick={closeModal}
              className="px-6 py-2 bg-base_color text-white rounded-md hover:bg-base_text transition duration-300"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-6 py-2 bg-base_text text-white rounded-md hover:bg-base_color transition duration-300"
            >
              Submit
            </button>
          </div>
