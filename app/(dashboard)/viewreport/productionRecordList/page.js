// src/app/productionRecordList/page.js
...
const ProductionRecordList = () => {
  ...
  useEffect(() => {
    const fetchEntries = async () => {
      const res = await fetch(`/api/productionRecords?month=${month + 1}&year=${year}`);
  ...
  return (
    <main className="bg-base_two mb-10 pt-40">
      ...
      <h1 className="text-2xl font-bold text-white mb-4">Worker Production List</h1>
